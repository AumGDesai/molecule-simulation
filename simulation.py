...
Do not run this file. Go to Molecules.py instead and follow the instructions. 
"""
                ...
                for i in sorted_initial_indexes:
                    ...
                    for j in range(len(temp_lines)):
                        ...
                        if i in temp_lines[j]:
                            ...
                            all_lines[j].undraw()
                            all_lines[j] = Line(spheres[temp_lines[j][0]].sphere.getCenter(),spheres[temp_lines[j][1]].sphere.getCenter())
                            all_lines[j].setWidth(5)
                            list_of_objs.append(all_lines[j])
                            temp_lines[j] = (-1,-1)
